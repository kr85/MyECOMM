...
(function ($, undefined) {
    ...
    mouseProto._mouseInit = function () {
        ...
        $(document).bind("touchmove." + this.widgetName, this._mouseMoveDelegate).bind("touchend." +
    ...
    $.widget("ui.iviewer", $.ui.mouse, {
        widgetEventPrefix: "iviewer", options: {
            zoom: "fit",
            zoom_base: 100,
            zoom_max: 800,
            zoom_min: 25,
        ...
        _updateContainerInfo: function () {
            ...
            this.img_object.load(src, function () {
                ...
                if (me.options.zoom == "fit")me.fit(true); else me.set_zoom(me.options.zoom, true);
                if (me.options.onFinishLoad)me._trigger("onFinishLoad", 0, src)
            })
        }, fit: function (skip_animation) {
            var aspect_ratio = this.img_object.orig_width() /
            ...
            var coords =
            {x: x - this.img_object.x(), y: y - this.img_object.y()};
            ...
            coords = this.containerToImage(e.pageX - containerOffset.left, e.pageY -
            containerOffset.top);
            return coords
            ...
            if (this.current_zoom == "fit") {
                ...
                var old_x =
                    -this.img_object.x() + Math.round(this.options.width / 2);
            ...
            if (delta > 0 && next_zoom <
                this.current_zoom)next_zoom *= this.options.zoom_delta;
            ...
            if (value ==
                this.options.zoom_base)return 0;
            ...
            if (!this.options.ui_disabled) {
                var percent = Math.round(100 * this.img_object.display_height() /
                this.img_object.orig_height());
            ...
            switch (param) {
                case "orig_width":
                case "orig_height":
                    if (withoutRotation)return this.img_object.angle() % 180 === 0 ? this.img_object[param]() : param === "orig_width" ? this.img_object.orig_height() : this.img_object.orig_width(); else return this.img_object[param]();
                case "display_width":
                case "display_height":
                case "angle":
            ...
            $.ui.mouse.prototype._mouseDrag.call(this,
                e);
            ...
            var me = this;
            $("<div>", {"class": "iviewer_zoom_in iviewer_common iviewer_button"}).bind("mousedown touchstart",
                function () {
                    me.zoom_by(1);
                    return false
            ...
            $("<div>", {"class": "iviewer_zoom_fit iviewer_common iviewer_button"}).bind("mousedown touchstart", function () {
                me.fit(this);
                return false
            }).appendTo(this.container);
            ...
            $("<div>", {"class": "iviewer_rotate_right iviewer_common iviewer_button"}).bind("mousedown touchstart", function () {
                me.angle(90);
                return false
            }).appendTo(this.container);
            this.update_status()
    ...
    (function () {
        ...
        this.load = function (src, loaded) {
            ...
            img.src = src;
            this._img.removeAttr("src").removeAttr("width").removeAttr("height").removeAttr("style").css({
                position: "absolute",
                top: "0px",
                left: "0px"
            });
        ...
        this.orig_width = this._dimension("orig", "width"), this.orig_height = this._dimension("orig", "height"), this.x = setter(function (val, skipCss) {
                this._x = val;
                if (!skipCss)this._img.css("left", this._x + (this._swapDimensions ? this.display_diff() / 2 : 0) + "px")
            },
            function () {
                return this._x
            });
        this.y = setter(function (val, skipCss) {
            this._y = val;
            if (!skipCss)this._img.css("top", this._y - (this._swapDimensions ? this.display_diff() / 2 : 0) + "px")
        }, function () {
            return this._y
        });
        ...
        this.toRealCoords = function (point) {
            switch (this.angle()) {
                ...
                case 270:
                    return {
                        x: this.x() +
                        point.y, y: this.y() + this.display_height() - point.x
                    }
            }
        };
        ...
        this.setImageProps = function (disp_w, disp_h, x, y, skip_animation, complete) {
            ...
            var params = {
                ...
                left: x + (this._swapDimensions ? this.display_diff() /
                2 : 0) + "px"
            };
            ...
            if (useIeTransforms && swapDims) {
                var ieh = this._img.width(), iew = this._img.height(), iedh = params.height - ieh;
                iedw = params.width - iew;
                delete params.width;
                delete params.height
            }
            if (this._do_anim && !skip_animation)this._img.animate(params, {
                duration: 200, complete: complete, step: function (now,
                                                                   fx) {
