            ...
            if ($_POST['submit'] == "Submit") {
                ...
                try {
                    ...
                    if (filter_var($to, FILTER_VALIDATE_EMAIL) === false) {
                        throw new phpmailerAppException(
                            "Email address " . $to . " is invalid -- aborting!<br />"
                        );
                    }
                ...
                $mail->Subject = $_POST['Subject'] . ' (PHPMailer test using ' . strtoupper(
                        $_POST['test_type']
                    ) . ')';
                ...
                try {
                    if (!$mail->Send()) {
                        ...
                        echo 'Message has been sent using ' . strtoupper(
                                $_POST['test_type']
                            ) . "<br /><br />";
                    }
                } catch (phpmailerAppException $e) {
                ...
                <form method="POST" enctype="multipart/form-data">
                    <?php $value = ($_POST['From_Name'] != '') ?
                        $_POST['From_Name'] :
                        ''; ?>
                    <input type="hidden" name="From_Name"
                           value="<?php echo $value; ?>">
                    <?php $value = ($_POST['From_Email'] != '') ?
                        $_POST['From_Email'] :
                        ''; ?>
                    <input type="hidden" name="From_Email"
                           value="<?php echo $value; ?>">
                    <?php $value = ($_POST['To_Name'] != '') ?
                        $_POST['To_Name'] :
                        ''; ?>
                    <input type="hidden" name="To_Name"
                           value="<?php echo $value; ?>">
                    <?php $value = ($_POST['To_Email'] != '') ?
                        $_POST['To_Email'] :
                        ''; ?>
                    <input type="hidden" name="To_Email"
                           value="<?php echo $value; ?>">
                    <?php $value = ($_POST['cc_Email'] != '') ?
                        $_POST['cc_Email'] :
                        ''; ?>
                    <input type="hidden" name="cc_Email"
                           value="<?php echo $value; ?>">
                    <?php $value = ($_POST['bcc_Email'] != '') ?
                        $_POST['bcc_Email'] :
                        ''; ?>
                    <input type="hidden" name="bcc_Email"
                           value="<?php echo $value; ?>">
                    <?php $value = ($_POST['Subject'] != '') ?
                        $_POST['Subject'] :
                        ''; ?>
                    <input type="hidden" name="Subject"
                           value="<?php echo $value; ?>">
                    <?php $value = ($_POST['Message'] != '') ?
                        $_POST['Message'] :
                        ''; ?>
                    <input type="hidden" name="Message"
                           value="<?php echo $value; ?>">
                    <?php $value = ($_POST['test_type'] != '') ?
                        $_POST['test_type'] :
                        'mail'; ?>
                    <input type="hidden" name="test_type"
                           value="<?php echo $value; ?>">
                    <?php $value = ($_POST['smtp_debug'] != '') ?
                        $_POST['smtp_debug'] :
                        $CFG['smtp_debug']; ?>
                    <input type="hidden" name="smtp_debug"
                           value="<?php echo $value; ?>">
                    <?php $value = ($_POST['smtp_server'] != '') ?
                        $_POST['smtp_server'] :
                        $CFG['smtp_server']; ?>
                    <input type="hidden" name="smtp_server"
                           value="<?php echo $value; ?>">
                    <?php $value = ($_POST['smtp_port'] != '') ?
                        $_POST['smtp_port'] :
                        $CFG['smtp_port']; ?>
                    <input type="hidden" name="smtp_port"
                           value="<?php echo $value; ?>">
                    <?php $value = ($_POST['smtp_authenticate'] != '') ?
                        $_POST['smtp_authenticate'] :
                        $CFG['smtp_authenticate']; ?>
                    <input type="hidden" name="smtp_authenticate"
                           value="<?php echo $value; ?>">
                    <?php $value = ($_POST['authenticate_username'] != '') ?
                        $_POST['authenticate_username'] :
                        $CFG['smtp_username']; ?>
                    <input type="hidden" name="authenticate_username"
                           value="<?php echo $value; ?>">
                    <?php $value = ($_POST['authenticate_password'] != '') ?
                        $_POST['authenticate_password'] :
                        $CFG['smtp_password']; ?>
                    <input type="hidden" name="authenticate_password"
                           value="<?php echo $value; ?>"> <input type="submit"
                                                                 value="Start Over"
                                                                 name="submit">
                </form><br/>
                <br/>
...
$mail = new PHPMailer();
                    ...
                    $mail->AddReplyTo('<?php echo $_POST['From_Email']; ?>
                    ','<?php echo $_POST['From_Name']; ?>');
...
$mail->FromName   = '<?php echo $_POST['From_Name']; ?>';
                    ...
                    $mail->Subject  = <?php echo $_POST['Subject']; ?>(PHPMailer test using <?php echo strtoupper(
                        $_POST['test_type']
                    ); ?>)
...
try {
  if ( !$mail->Send() ) {
    ...
    echo 'Message has been sent using <?php echo strtoupper(
                        $_POST['test_type']
                    ); ?><br/><br/>';
  }
} catch (phpmailerAppException $e) {
    ...
    echo $thisError . ': ' . $value;
            ...
            <?php
                ...
                <form method="POST" enctype="multipart/form-data">
                        ...
                        <tr>
                            <td valign="top" ;>
                                ...
                                <table border="1" width="450" cellspacing="0"
                                    ...
                                    <tr>
                                        <td class="colleft">From Email Address
                                        </td>
                                        <?php $value = ($_POST['From_Email'] != '') ?
                                            $_POST['From_Email'] :
                                            ''; ?>
                                    ...
                                    <tr>
                                        <td class="colleft">To Email Address
                                        </td>
                                        <?php $value = ($_POST['To_Email'] != '') ?
                                            $_POST['To_Email'] :
                                            ''; ?>
                                    ...
                                    <tr>
                                        <td class="colleft">cc Email Addresses
                                            <small>(separate with commas)
                                            </small>
                                        </td>
                                        <?php $value = ($_POST['cc_Email'] != '') ?
                                            $_POST['cc_Email'] :
                                    ...
                                    <tr>
                                        <td class="colleft">bcc Email Addresses
                                            <small>(separate with commas)
                                            </small>
                                        </td>
                                        <?php $value = ($_POST['bcc_Email'] != '') ?
                            ...
                            <td valign="top"><strong>Mail Test
                                    Specs</strong><br/><br/>
                                <table border="1" width="450" cellspacing="0"
                                       cellpadding="5"
                                       style="border-collapse: collapse;"
                                        ...
                                        <td class="colrite">
                                            <table>
                                                <tr>
                                                    <td><input type="radio"
                                                               name="test_type"
                                                               value="mail" <?php echo ($_POST['test_type'] == 'mail') ?
                                                            'checked' :
                                                            ''; ?>></td>
                                                    <td>Mail()</td>
                                                </tr>
                                                <tr>
                                                    <td><input type="radio"
                                                               name="test_type"
                                                               value="sendmail" <?php echo ($_POST['test_type'] == 'sendmail') ?
                                                            'checked' :
                                                            ''; ?>></td>
                                                    <td>Sendmail</td>
                                                </tr>
                                                <tr>
                                                    <td><input type="radio"
                                                               name="test_type"
                                                               value="qmail" <?php echo ($_POST['test_type'] == 'qmail') ?
                                                            'checked' :
                                                            ''; ?>></td>
                                                    <td>Qmail</td>
                                                </tr>
                                                <tr>
                                                    <td><input type="radio"
                                                               name="test_type"
                                                               value="smtp" <?php echo ($_POST['test_type'] == 'smtp') ?
                                                            'checked' :
                                                            ''; ?>></td>
                                                    <td>SMTP</td>
                                                </tr>
                                ...
                                <table border="1" width="450" cellspacing="0"
                                    ...
                                    <tr>
                                        ...
                                        <?php $value = ($_POST['smtp_debug'] != '') ?
                                            $_POST['smtp_debug'] :
                                            $CFG['smtp_debug']; ?>
                                        <td class="colrite"><select size="1"
                                                                    name="smtp_debug">
                                                <option <?php echo ($value == '0') ?
                                                    'selected' :
                                                    ''; ?> value="0">0 -
                                                    Disabled
                                                </option>
                                                <option <?php echo ($value == '1') ?
                                                    'selected' :
                                                    ''; ?> value="1">1 - Errors
                                                    and Messages
                                                </option>
                                                <option <?php echo ($value == '2') ?
                                                    'selected' :
                                                    ''; ?> value="2">2 -
                                                    Messages only
                                                </option>
                                    ...
                                    <tr>
                                        <td class="colleft">SMTP Authenticate
                                            ?
                                        </td>
                                        <?php $value = ($_POST['smtp_authenticate'] != '') ?
                                            $_POST['smtp_authenticate'] :
                                            $CFG['smtp_authenticate']; ?>
                                        <td class="colrite"><input
                                                type="checkbox"
                                                name="smtp_authenticate" <?php if ($value != '') {
                                                echo "checked";
                                            } ?> value="<?php echo $value; ?>">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="colleft">Authenticate
                                            Username
                                        </td>
                                        <?php $value = ($_POST['authenticate_username'] != '') ?
                                            $_POST['authenticate_username'] :
                    ...
                    <br/> Test will include two attachments, plus one of the
                    attachments is used as an inline graphic in the message
                    body.<br/> <br/> <input type="submit" value="Submit"
                                            name="submit">
                </form>
            <?php
            }
