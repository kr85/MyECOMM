    ...
    if (!empty($user)) {
        ...
        <form action="" method="POST">
            <table class="tbl_insert">
                ...
                <tbody id="deliveryAddress" class="same_address<?php
                ...
                >
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" name="shipping_city" id="shipping_city" class="fld"
                                   value="<?php echo $objForm->stickyText(
                                       'shipping_city',
                                       $user['shipping_city']
                                   ); ?>"/>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" name="shipping_state" id="shipping_state" class="fld"
                                   value="<?php echo $objForm->stickyText(
                                       'shipping_state',
                                       $user['shipping_state']
                                   ); ?>"/>
