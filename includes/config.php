<?php
    ...
    defined("COUNTRY_LOCAL") || define("COUNTRY_LOCAL", 230);

    // Whether the vat should apply to the sales outside of the local country
    defined("INTERNATIONAL_VAT") || define("INTERNATIONAL_VAT", false);

    // Page extension
    defined("PAGE_EXTENSION") || define("PAGE_EXTENSION", " ");
    ...
    // Plugin folder
    defined("PLUGIN_DIR") || define("PLUGIN_DIR", "plugin");
